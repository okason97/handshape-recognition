...
try:
    ...
    print('test.py --dataset=rwth --rotation=10 --w-shift=0.1 --h-shift=0.1 h-flip=True growth-r=128 nb-layers=6:12 reduction=0.0 lr=0.001 epochs=400 patience=25 log-freq=1 save-freq=40 models-dir=models results_dir=results checkpoints=True')
    sys.exit(2)
